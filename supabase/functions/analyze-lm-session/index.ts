...
- messaging.strategie_uctu: 2-3 věty senior stratéga, které INTERPRETUJÍ, ne popisují. Nestačí převyprávět čísla ("hodně videí, krátká rotace") — řekni, CO to o hráči vypovídá: na co sází, kde má sílu, kde slabinu nebo nevyužitý prostor, a co z toho plyne pro konkurenci. KAŽDÉ tvrzení ukotvi konkrétním číslem nebo faktem z dat (počty formátů, poměr typů sdělení, doba běhu, slevová mechanika v copy, témata, CTA). Příklady tónu: "Denatura sází na výkonnostní akvizici přes UGC video (16 z 30 reklam) a rychlou obměnu — průměrný běh 84 dní ukazuje, že zaběhnuté kreativy nechává dlouho točit. Brand vrstva je tenká (jen pár značkových reklam), což otevírá prostor pro odlišení skrz budování značky." / "Saloos staví skoro výhradně na videu (21 z 30), takže je silný v storytellingu, ale chybí mu formátová diverzita — žádné bannery, minimum katalogu — což limituje rychlé prodejní sdělení." NESMÍ citovat doslovně copy z reklam, parafrázovat USP ani fabulovat motivy bez datové opory. Drž tvrdá pravidla (žádný placement, rozpočet, cílení, výsledky).
